...
<section class="main">
	...
	<nav>
        ...
        <h1><?php print _("Snippets"); ?></h1>
        
        <a class="primary-action" data-bind="click: showAddDialog"><?php print _("Add Snippet"); ?></a>
        ...
        <div class="dropdown more">
		  ...
		  <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="more-menu">	
			  <li><a data-bind="click: showRemoveDialog"><?php print _("Remove Snippet"); ?></a></li>
		  </ul>
		</div>
    </nav>
