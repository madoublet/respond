    ...
    <nav>
        ...
        <div class="fs-container full">
			...
			<div class="fs">
		        ...
		        <ul>
		        <!-- ko foreach: snippets -->
		            <li data-bind="attr:{'data-file': file}"><a data-bind="text: file, click: $parent.updateContent"></a><i data-bind="click: $parent.showRemoveDialog" class="fa fa-minus-circle show-tooltip" title="<?php print _("Remove Snippet"); ?>"></i></li>
		        <!-- /ko -->    
