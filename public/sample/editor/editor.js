...
editor = (function() {
  ...
  return {
    ...
    setupBlocks: function() {
      ...
      for (y = 0; y < els.length; y += 1) {
        ...
        if(els[y].querySelector('.editor-block-menu') === null) {
          ...
          span.innerHTML = '<x-respond-menu-icon class="material-icons">arrow_upward</x-respond-menu-icon> Move Up';
          ...
          span.innerHTML = '<x-respond-menu-icon class="material-icons">arrow_downward</x-respond-menu-icon> Move Down';
    ...
    setupElementMenu: function(el) {
      ...
      span.innerHTML = '<x-respond-menu-icon class="material-icons">apps</x-respond-menu-icon> Move';
    ...
    createMenu: function() {
      ...
      var menu = [
        ...
        },
        {
          ...
          title: "H1 Headline",
          display: "H1",
          html: '<h1>Tap to update</h1>'
        }, {
          selector: "h2",
          title: "H2 Headline",
          display: "H2",
          html: '<h2>Tap to update</h2>'
        }, {
          selector: "h3",
          title: "H3 Headline",
          display: "H3",
          html: '<h3>Tap to update</h3>'
        }, {
          selector: "h4",
          title: "H4 Headline",
          display: "H4",
          html: '<h4>Tap to update</h4>'
        }, {
          selector: "h5",
          title: "H5 Headline",
          display: "H5",
          html: '<h5>Tap to update</h5>'
        }, {
          selector: "p",
          title: "Paragraph",
          display: "P",
          html: '<p>Tap to update</p>'
        }, {
          selector: "blockquote",
          title: "Blockquote",
          display: "<i class=\"material-icons\">format_quote</i>",
          html: '<blockquote>Tap to update</blockquote>'
        },{
          selector: "pre",
          title: "Code",
        ...
        },
        {
          ...
          html: '<ul><li>Tap to update</li></ul>'
        }, {
          selector: "ol",
          title: "Ordered List",
              ...
              while (el !== null) {
                ...
                if(text === '' && el.childNodes.length == 1) {
                  ...
                  if(editor.current.linkSelection != '') {
                    ...
                    text = document.createTextNode('Tap to update');
            ...
            if (e.target.hasAttribute('contentEditable')) {
              ...
              if (e.keyCode === 13) {
                ...
                if (el.nodeName == 'LI') {
                  ...
                  var node = editor.append('<p>Tap to update</p>');
