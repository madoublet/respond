...
/*
 * Handles background video in respond
 */
respond.backgroundVideo = (function () {
    ...
    return {
        ...
        setup: function () {
            ...
            // setup maps
            bgvideo = document.querySelectorAll('[type=bgvideo]');

            // setup submit event for form
            for (x = 0; x < maps.length; x++) {
                respond.backgroundVideo.setupVideo(bgvideo[x]);
            }
        },

        /**
         * Setups a backgroundVideo
         *
         */
