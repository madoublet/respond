...
<?php } ?>
<script type="text/javascript" src="<?php print $rootloc; ?>js/jquery.respondMap.js?v=<?php print VERSION; ?>"></script>
<script type="text/javascript" src="<?php print $rootloc; ?>js/jquery.respondForm.js?v=<?php print VERSION; ?>"></script>
<script type="text/javascript" src="<?php print $rootloc; ?>js/jquery.respondCalendar.js?v=<?php print VERSION; ?>"></script>
