...
plugin.samplert = {
	...
	init:function(pageUniqId, pluginUniqId){
		...
		$('#samplert-var1').val($('#'+plugin.samplert.pluginUniqId).attr('data-var1'));
		$('#samplert-var2').val($('#'+plugin.samplert.pluginUniqId).attr('data-var2'));
	...
	update:function(el){
		...
		$('#'+plugin.samplert.pluginUniqId).attr('data-var1', $('#samplert-var1').val());
		$('#'+plugin.samplert.pluginUniqId).attr('data-var2', $('#samplert-var2').val());
