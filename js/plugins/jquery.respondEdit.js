					...
					if(node.nodeName=='MODULE'){
						...
						if(name=='slideshow'){
						  	...
						  	for(var y=0; y<imgs.length; y++){
								...
								response +='<span class="image">' + imghtml + '<a class="image-control edit-image-properties fa fa-cog"></a><a class="image-control remove-image fa fa-minus-circle"></a></span>';
						  	}
